...
@NamedQueries({
    ...
    , @NamedQuery(name = "Wishlist.findByNotified", query = "SELECT w FROM Wishlist w WHERE w.notified = :notified")})
public class Wishlist implements Serializable {
    ...
    public Wishlist(Integer id, int quantity, boolean notified) {
        this.id = id;
